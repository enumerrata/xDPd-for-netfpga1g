...
afa_result_t fwd_module_init(){
	...
	ROFL_ERR("["FWD_MOD_NAME"] !!!!!!!!! WARNING: NetFPGA 10G forwarding module is experimental. Be advised. !!!!!!!!! - SRC modified to NetFPGA1G\n");
...
dd
	ROFL_INFO("["FWD_MOD_NAME"] end of  fwd_mod_init()\n");
	return AFA_SUCCESS; 
