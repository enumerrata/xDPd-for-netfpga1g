...
void update_misc_stats(){
	...
	port[0] = physical_switch_get_port_by_name("nf2c0");
	port[1] = physical_switch_get_port_by_name("nf2c1");
	port[2] = physical_switch_get_port_by_name("nf2c2");
	port[3] = physical_switch_get_port_by_name("nf2c3");
